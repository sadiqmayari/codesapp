...
export function Sidebar({
  ...
  const items: NavItem[] = [
    ...
    { href: '/contacts', label: 'Contacts', icon: Users, enabled: false },
    { href: '/templates', label: 'Templates', icon: FileText, enabled: false },
    { href: '/broadcasts', label: 'Broadcasts', icon: Megaphone, enabled: false },
    { href: '/bots', label: 'Bots', icon: Bot, enabled: false },

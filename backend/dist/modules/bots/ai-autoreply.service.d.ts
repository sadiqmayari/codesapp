...
export declare class AiAutoReplyService implements OnModuleInit {
    ...
    constructor(prisma: PrismaService, jobQueue: JobQueueService, ai: AiService, platformSetting: PlatformSettingService, companyStatus: CompanyStatusService, inboxService: InboxService, gateway: InboxGateway);
    onModuleInit(): void;

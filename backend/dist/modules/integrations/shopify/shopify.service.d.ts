...
export declare class ShopifyService implements OnModuleInit {
    ...
    constructor(prisma: PrismaService, config: ConfigService, encryption: EncryptionService, jobQueue: JobQueueService, metering: UsageMeteringService, inbox: InboxService, aiKnowledge: AiKnowledgeService, rag: AiRagService);
    onModuleInit(): void;
    private processJob;
    ...
    knowledgeStatus(companyId: number): Promise<{
        configured: boolean;
        products: number;
        policies: number;
        total: number;
    ...
    getLastOrderItems(companyId: number, phone: string, email?: string): Promise<{
        found: boolean;
        name?: string;
        shipping?: {
            name?: string;
